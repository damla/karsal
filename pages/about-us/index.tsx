      ...
      <Layout data={common} navbarBg>
        ...
        <Section relative>
          <div className={styles.section_container}>
            ...
            <h3 className={styles.h2}>Karsal Örme Tekstil San. A.Ş., 1970’li yıllarda Trabzon’da peştemal işleri ile tekstile başlayan KÖKSAL ailesi nin ikinci kuşak  aile fertleri tarafından 1995 yılında İstanbul’da kurulmuştur.</h3>
